...
//        // Проверяем, что start не в прошлом (с погрешностью 1 секунда)
//        LocalDateTime now = LocalDateTime.now();
//        LocalDateTime startWithTolerance = bookingDto.getStart().minusSeconds(1);
//
//        if (startWithTolerance.isBefore(now)) {
